...
const getFullUserHistory = async (userId) => {
    try {
        ...
        console.error('[getFullUserHistory] Error fetching user history:', error);
        return {};
    }
};
...
export const generateWorkoutPlan = async (userId, profile) => {
    try {
        ...
        console.error('[generateWorkoutPlan] Error generating workout plan:', error);
...
export const getTodayWorkout = async (userId) => {
    try {
        ...
        console.error('[getTodayWorkout] Error fetching today workout:', error);
        return null;
    }
};
